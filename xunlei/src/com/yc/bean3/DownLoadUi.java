...
public class DownLoadUi {
	...
	protected void createContents() {
		...
		txtHttpdldirqqcominvcqqpinyinqqpinyinsetupexe = new Text(shell, SWT.BORDER);
		txtHttpdldirqqcominvcqqpinyinqqpinyinsetupexe.setText("http://dldir1.qq.com/qqfile/qq/QQ8.4/18380/QQ8.4.exe");
		txtHttpdldirqqcominvcqqpinyinqqpinyinsetupexe.setBounds(173, 29, 460, 18);
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				 ip=txtHttpdldirqqcominvcqqpinyinqqpinyinsetupexe.getText().toString().trim();
				 threadSize=Integer.parseInt( combo.getText().toString().trim()  );
				...
				combo.setEnabled(false);
				 ...
				 label_2.setText(   "肖前下载的文件:"+ xl.getFileName(ip));
				...
				try {
					...
					new Thread(new Runnable(){
						...
						public void run() {
							try {
								xl.download(ip, threadSize,    new OnSizeChangeListener(){
									@Override
										...
										Display.getDefault().asyncExec(new Runnable(){
											...
											public void run() {
												...
												if(   totalsize==sum ){
													...
													txtHttpdldirqqcominvcqqpinyinqqpinyinsetupexe.setEnabled(true);
