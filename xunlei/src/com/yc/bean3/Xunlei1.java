...
public class Xunlei1 {
	...
	public static void main(String[] args) throws IOException {
		String path="http://dldir1.qq.com/qqfile/qq/QQ8.4/18380/QQ8.4.exe";
		int threadSize=5;
	...
	public void download( String path,   int threadSize,   OnSizeChangeListener   listener   ) throws IOException{
