...
public class EmpHandler {
	...
	public String save(@RequestParam("emp")Employee emp, ModelMap map) {
	...
	@RequestMapping(value = "/emp", method = RequestMethod.POST)
	public String save(@Valid Employee emp, BindingResult bindingResult , ModelMap map) {
		LogManager.getLogger().debug("/save请求成功到达处理方法中, 请求参数\n\temp ==>" + emp);
		//employeeDao.save(emp);
	...
	public void InitBinder(WebDataBinder dataBinder){
		dataBinder.setDisallowedFields("birthday");  //不允许注入的请求参数名
	}*/
}